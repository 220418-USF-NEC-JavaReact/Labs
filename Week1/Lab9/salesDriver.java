public class salesDriver {
    public static void main(String[] args) {
        ...
        PremiumCustomer cust01 = new PremiumCustomer (123, 10, "Robert", 543.67d, newCart, 0.0d);

        cust01.addToCart("shirt", 4.54d);
        cust01.addToCart("blue shirt", 7.52d);
        cust01.addToCart("green shirt", 9.73d);

        for(int i = 0; i < cust01.getCartLength(); i++) {
            System.out.println("Item: " + cust01.cart[i]);
        }
